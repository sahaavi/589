...
Below we will see a plot of Canada Lynx within BC.
...
Now we can combine the two to show the observations within the window.
...
Many of our hypotheses were found to be true. We found in the plots that the assumption of homogeneity is not appropriate for this Lynx dataset because the Lynx were clustered in certain areas of the observation window, whereas other locations had no Lynx at all.
