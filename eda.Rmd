...
Seems like clustering occurs for ca. 13500. There appear to be more lynx than expected by random chance between 0 - 13500. Beyond that, the locations of lynx appear not to exhibit any significant correlations.
...
```{r}
# Fit the PPP model
fit <- ppm(lc_ppp ~ Elevation , data = DATA)
```
